...
├── magicwatch-latest.zip # Standalone portable distribution package for Magic-Watch v1.1.0
...
- **Port**: Exposed on port 80 to Coolify proxy network (Caddy / Traefik handles TLS certificates).
